  ...
  return (
    <>
      <header className="border-b border-border bg-bg/80 backdrop-blur-md sticky top-0 z-50">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            <Link href="/vault" className="text-xs text-text-muted hover:text-text-base transition-colors font-mono">
              vault
            </Link>
            <Link href="/guides" className="text-xs text-text-muted hover:text-text-base transition-colors font-mono">
              guides
            </Link>
            <SignOutButton />
          </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        {/* Saved configs — Phase 2 placeholder */}
